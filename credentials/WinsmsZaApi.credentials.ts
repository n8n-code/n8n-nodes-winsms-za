...
export class WinsmsZaApi implements ICredentialType {
	name = 'N8nDevWinsmsZaApi';

	displayName = 'winsms-za API';

	icon: Icon = { light: 'file:../nodes/WinsmsZa/winsms-za.png', dark: 'file:../nodes/WinsmsZa/winsms-za.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your winsms-za API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
